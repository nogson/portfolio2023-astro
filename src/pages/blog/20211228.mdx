...
<CommonImg
  src="blog/images/20211228/01.png"
  alt="シェイプキーを追加"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20211228/02.png"
  alt="シェイプキーを追加"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20211228/03.png"
  alt="アニメーションさせる"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20211228/04.png"
  alt="アニメーションさせる"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20211228/05.png"
  alt="アニメーションさせる"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20211228/06.png"
  alt="アニメーションさせる"
  client:only="react"
/>
...
- 100フレーム ・・・値:0
  <CommonImg
    src="blog/images/20211228/07.png"
    alt="アニメーションさせる"
    client:only="react"
  />
...
<CommonImg
  src="blog/images/20211228/08.gif"
  alt="アニメーションさせる"
  client:only="react"
/>
