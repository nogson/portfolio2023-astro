...
2. ガイドがメートル単位になっているので、「拡大縮小」を0.01に変更
   <CommonImg
     src="blog/images/20211218/01.png"
     alt="単位変更"
     client:only="react"
   />
...
<CommonImg
  src="blog/images/20211218/02.png"
  alt="単位変更"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20211218/03.png"
  alt="Auto Mirror"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20211218/04.png"
  alt="Auto Mirror"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20211218/05.png"
  alt="Auto Mirror"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20211218/06.png"
  alt="自動マージ"
  client:only="react"
/>
