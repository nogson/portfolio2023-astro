...
<CommonImg
  src="blog/images/20200501/01.png"
  alt="プライベートサブネットとは"
  client:only="react"   
/>
...
<CommonImg
  src="blog/images/20200501/02.png"
...
<CommonImg
  src="blog/images/20200501/03.png"
  alt="プライベートサブネットにサーバーを構築する"
  client:only="react"
/>

<CommonImg
  src="blog/images/20200501/04.png"
  alt="プライベートサブネットにサーバーを構築する"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200501/05.png"
  alt="プライベートサブネットにサーバーを構築する"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200501/06.png"
  alt="プライベートサブネットにサーバーを構築する"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200501/07.png"
  alt="ICMPがとおるようにする"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200501/08.png"
  alt="ICMPがとおるようにする"
  client:only="react"
/>
