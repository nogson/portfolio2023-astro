...
<CommonImg
  src="blog/images/20200805/01.png"
...
<CommonImg
  src="blog/images/20200805/02.png"
...
<CommonImg
  src="blog/images/20200805/03.png"
  alt="ECRにdockerイメージをpush"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200805/04.png"
  alt="ECRにdockerイメージをpush"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200805/05.png"
  alt="ECRにdockerイメージをpush"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200805/06.png"
  alt="タスクを定義する"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200805/07.png"
  alt="クラスターを作成"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200805/08.png"
  alt="クラスターを作成"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200805/09.png"
  alt="クラスターでタスクを実行"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200805/11.png"
  alt="クラスターでタスクを実行"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20200805/12.png"
  alt="クラスターでタスクを実行"
  client:only="react"
/>
