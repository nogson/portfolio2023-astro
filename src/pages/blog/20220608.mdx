...
| シェーダー                                                                           | 透過テクスチャ                                                                           |
| ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------- |
| <CommonImg src="blog/images/20220608/01.png" alt="シェーダー" client:only="react" /> | <CommonImg src="blog/images/20220608/02.png" alt="透過テクスチャ" client:only="react" /> |

仕上がりイメージはこんな感じ。

<CommonImg
  src="blog/images/20220608/03.png"
  alt="シェーダー"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220608/04.png"
  alt="シェーダー"
  client:only="react"
/>
