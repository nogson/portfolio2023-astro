...
<CommonImg src="blog/images/20220219/01.png" alt="たまご" client:only="react" />

レンダリングするとこんな感じ。

<CommonImg src="blog/images/20220219/02.png" alt="たまご" client:only="react" />
...
<CommonImg src="blog/images/20220219/03.png" alt="みかん" client:only="react" />

レンダリングするとこんな感じ。

<CommonImg src="blog/images/20220219/04.png" alt="みかん" client:only="react" />

## 木目

<CommonImg src="blog/images/20220219/05.png" alt="木目" client:only="react" />

レンダリングするとこんな感じ。

<CommonImg src="blog/images/20220219/06.png" alt="木目" client:only="react" />
