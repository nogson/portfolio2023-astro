...
| リメッシュ前                                                                           | リメッシュ後                                                                           |
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| <CommonImg src="blog/images/20220115/06.png" alt="リメッシュ前" client:only="react" /> | <CommonImg src="blog/images/20220115/07.png" alt="リメッシュ後" client:only="react" /> |

形状を変形後、画面右上の「リメッシュ」からリメッシュを実行します。

<CommonImg
  src="blog/images/20220115/08.png"
  alt="リメッシュ"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220115/01.png"
  alt="ダイナミックトポロジー"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220115/13.png"
  alt="ダイナミックトポロジー"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220115/b_mask.png"
  alt="スカルプトさせない"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220115/02.png"
  alt="スカルプトさせない"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220115/03.png"
  alt="スカルプトさせない"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220115/04.png"
  alt="スカルプトさせない"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220115/05.png"
  alt="左右対称にする場合"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220115/10.png"
  alt="シュリンクラップ"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220115/11.png"
  alt="シュリンクラップ"
  client:only="react"
/>
...
<CommonImg
  src="blog/images/20220115/12.png"
  alt="Instant Meshes"
  client:only="react"
/>
...
| ブラシ名                                                                                   | 機能                                               |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------- |
| <CommonImg src="blog/images/20220115/b3.png" alt="ドロー" client:only="react" />           | 凹凸をつくる基本ブラシ                             |
| <CommonImg src="blog/images/20220115/b3.png" alt="グラブ" client:only="react" />           | 形を整える                                         |
| <CommonImg src="blog/images/20220115/b4.png" alt="クレイストリップ" client:only="react" /> | 雑に粘土を盛るように細かく粘土を増やすことができる |
| <CommonImg src="blog/images/20220115/b5.png" alt="クリース" client:only="react" />         | 鋭い切れ込みをいれる                               |
| <CommonImg src="blog/images/20220115/b6.png" alt="スムーズ" client:only="react" />         | なめらかにする                                     |
| <CommonImg src="blog/images/20220115/b7.png" alt="削り取り" client:only="react" />         | デコボコをけずる                                   |
| <CommonImg src="blog/images/20220115/b8.png" alt="スネークフック" client:only="react" />   | ひっぱったような形状をつくる                       |
...
<CommonImg
  src="blog/images/20220115/09.png"
  alt="スネークフック"
  client:only="react"
/>
