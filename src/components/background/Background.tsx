...
import BackgrounGltfModels from "./BackgroundGltfModels";
import BackgroundImages from "./BackgroundGradationCircles";
    ...
    <BackgroundWrapper>
      ...
      <Canvas>
        <PerspectiveCamera
          ...
          position={[0, 0, 0]}
          rotation={[0, rate * -0.25, 0]}
        />

        <ambientLight intensity={0.5} />
        <directionalLight castShadow position={[-12, 0, 5]} intensity={3.5} />

        <fog attach="fog" color={"#e9e9e9"} near={5} far={20} />
